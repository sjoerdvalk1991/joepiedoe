var geo = {
    ...
    var p5 = new LatLon(52.3598956, 4.9084882);
        var p6 = new LatLon(locaties.locatie3.latitude, locaties.locatie3.longitude);
        console.log(locaties.locatie3.latitude, locaties.locatie3.longitude);
        var brng3 = p5.bearingTo(p6);
        console.log(brng3 + "dit is de hoek");
          
          
       $( "#next3" ).click(function() {
             console.log(compass.magneticHeading - brng3);
             if (compass.magneticHeading - brng3 >= -5 && compass.magneticHeading - brng3 <= 5) {
